      ...
      <main className="flex-1">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              <motion.h1 
                className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary-700 to-primary-500"
                variants={fadeIn}
              >
                NUVI와 함께,<br />
                안전하고 빠른 이동을 누려보세요.
              ...
              <motion.p 
                className="text-lg text-neutral-700 mb-8 max-w-xl"
                variants={fadeIn}
              >
              ...
              >
                <motion.div variants={scaleIn} className="text-center">
                  ...
                  <p className="text-sm text-neutral-600">고객 만족도</p>
                </motion.div>
                <motion.div variants={scaleIn} className="text-center">
                  <p className="text-3xl font-bold text-primary-700">5분</p>
                  <p className="text-sm text-neutral-600">평균 대기 시간</p>
                </motion.div>
                <motion.div variants={scaleIn} className="text-center">
                  <p className="text-3xl font-bold text-primary-700">24/7</p>
                  <p className="text-sm text-neutral-600">서비스 운영</p>
                </motion.div>
              </motion.div>
              ...
              >
                <motion.div variants={scaleIn}>
                  <Card className="p-6 bg-white border-none shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                    ...
                    <h3 className="font-semibold text-lg mb-2">빠른 예약</h3>
                    <p className="text-sm text-neutral-700">몇 번의 클릭만으로 공항 내 이동 서비스를 예약하세요. 간편한 UI로 누구나 쉽게 이용할 수 있습니다.</p>
                  </Card>
                </motion.div>
                ...
                <motion.div variants={scaleIn}>
                  <Card className="p-6 bg-white border-none shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                    ...
                    <h3 className="font-semibold text-lg mb-2">실시간 추적</h3>
                    <p className="text-sm text-neutral-700">모빌리티 로봇의 현재 위치를 실시간으로 확인하세요. 언제 도착할지 정확히 알 수 있습니다.</p>
                  </Card>
                </motion.div>
                ...
                <motion.div variants={scaleIn}>
                  <Card className="p-6 bg-white border-none shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                    ...
                    <p className="text-sm text-neutral-700">최적화된 경로로 안전하게 목적지까지 안내해 드립니다. 장애물 감지 시스템으로 안전을 보장합니다.</p>
                  </Card>
                </motion.div>
              </motion.div>
            </motion.div>
            ...
            {/* Right Image */}
            <motion.div 
              className="flex-1 relative rounded-3xl overflow-hidden shadow-2xl h-[500px]"
            ...
            >
              ...
              >
                <h3 className="text-lg font-semibold mb-2">지금 바로 시작하세요</h3>
                <p className="text-sm text-neutral-700 mb-4">NUVI 서비스로 더 편리한 공항 경험을 만나보세요.</p>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              <div className="absolute top-1/2 -left-12 -translate-y-1/2 z-10">
                <button 
                  onClick={handlePrev}
                  className="bg-white rounded-full p-3 shadow-lg hover:bg-primary-100 transition-colors duration-200"
                  aria-label="이전 후기"
                >
                    ...
                    >
                      ...
                      <div className="flex text-secondary-500 mb-4">
                        {[...Array(testimonials[currentTestimonial].rating)].map((_, j) => (
                          <svg key={j} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="mx-1">
                            <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                          </svg>
                        ))}
                      </div>
                      
                      <p className="text-neutral-700 text-center text-lg mb-4 italic">
                        "{testimonials[currentTestimonial].text}"
                      </p>
                      
                      <h4 className="font-semibold text-xl text-primary-700">
                ...
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`mx-1 w-3 h-3 rounded-full transition-all duration-300 ${
                      index === currentTestimonial ? 'bg-primary-500 w-6' : 'bg-neutral-300'
                    }`}
        ...
        {/* Banner Section */}
        <motion.div 
          className="py-12 bg-gradient-to-r from-primary-700 to-primary-500"
          initial={{ opacity: 0 }}
          animate={isLoaded ? { opacity: 1 } : { opacity: 0 }}
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="md:w-1/2 mb-4 md:mb-0">
                ...
                >
                  ...
                  <p className="text-white/90 mb-4 max-w-lg text-sm md:text-base">
                    웹사이트에서 바로 예약하고 실시간으로 NUVI 로봇의 위치를 확인하세요. 공항 내 어디서든 편리하게 서비스를 이용할 수 있습니다.
                  </p>
                  <div className="flex flex-wrap gap-3">
                    <Button asChild size="sm" className="bg-white text-primary-700 hover:bg-neutral-100 rounded-full">
        ...
        {/* Divider */}
        <div className="h-16 bg-gradient-to-b from-primary-500 to-primary-800 relative overflow-hidden">
        ...
        {/* CTA Section */}
        <motion.div 
          className="bg-primary-800 text-white py-16 relative overflow-hidden"
          initial={{ opacity: 0 }}
          animate={isLoaded ? { opacity: 1 } : { opacity: 0 }}
          transition={{ duration: 0.8, delay: 1.2 }}
        >
          ...
          <div className="absolute top-0 left-0 w-full h-full">
            <div className="absolute top-10 left-10 w-64 h-64 rounded-full bg-primary-700/30 blur-3xl"></div>
            <div className="absolute bottom-10 right-10 w-80 h-80 rounded-full bg-primary-900/30 blur-3xl"></div>
          </div>
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <motion.div
              ...
              animate={isLoaded ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
              transition={{ duration: 0.5, delay: 1.4 }}
              className="bg-primary-900/60 backdrop-blur-sm py-10 px-6 rounded-xl shadow-xl border border-white/10"
            >
              <div className="flex flex-col md:flex-row items-center justify-between max-w-none">
                <div className="md:w-1/2 mb-6 md:mb-0 text-left md:pr-8">
                  <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white drop-shadow-md">지금 바로 시작하세요</h2>
                ...
                <div className="md:w-auto flex justify-center">
                  <Button asChild size="lg" className="bg-white hover:bg-neutral-100 shadow-lg hover:shadow-xl transition-all duration-300 rounded-full px-8 font-semibold">
