                    ...
                    {isLoading ? (
                      ...
                      facilities.map(facility => (
                        <motion.div
                          key={facility.id}
                          whileHover={{ x: 3 }}
                          className="p-3 rounded-lg cursor-pointer border bg-white border-neutral-200 hover:border-primary-200"
                  ...
                  >
                    ...
                    {!isLoading && !isError && facilities.map(facility => (
                      <motion.div
                        ...
                        onClick={() => handleMarkerClick(facility)}
                      >
                        <div className="p-2 rounded-full bg-white text-primary-500 border border-primary-300 z-10">
                          {renderIcon(facilityCategories.find(cat => cat.id === facility.category)?.icon || 'map-pin')}
                        </div>
                      </motion.div>
                    ))}
